...
5. Run `review-recent-work` to review the implementation against the decision rationale and the ExecPlan.

Use `goalcraft` separately when a durable objective needs a compact, evidence-checked `/goal` contract.
